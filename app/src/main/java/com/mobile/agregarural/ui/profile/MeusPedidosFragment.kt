...
import com.mobile.agregarural.data.model.ItemPedidoUsuario
                ...
                for (pedidoSnapshot in snapshot.children) {
                    ...
                    for (itemSnapshot in pedidoSnapshot.child("itens").children) {
                        val item = ItemPedidoUsuario(
                            ...
                            precoUnitario = itemSnapshot.child("precoUnitario")
                                .getValue(Double::class.java) ?: 0.0,
                            quantidade = itemSnapshot.child("quantidade").getValue(Int::class.java)
                                ?: 0,
                            subtotal = itemSnapshot.child("subtotal").getValue(Double::class.java)
                                ?: 0.0,
